...
class ParentApp extends Component {
  ...
  handleRefresh = () => {
    this.setState((prevState) => {
      return { ...prevState, refreshed: prevState.refreshed }
    })
  }
  ...
  render() {
    return (
        <div className={classes.parentApp}>
          ...
          <div className={classes.viewSummaryButton}>
            {this.state.showSummary ?
                  <React.Fragment>
                    ...
                    />
                    {/*<div>*/}
                    {/*  <Button variant="contained" color="primary" size="large" onClick={this.handleRefresh}>*/}
                    {/*    Refresh*/}
                    {/*  </Button>*/}
                    {/*</div>*/}
                  </React.Fragment>
                ...
                <Button variant="contained" color="primary" size="large" startIcon={<MonetizationOnIcon/>}
                        onClick={this.showSummarySection}>
                  View Summary
                </Button>
            }
